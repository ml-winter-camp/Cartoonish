...
parser.add_argument('--model_name', type=str, default='real_glasses_classification.pth',
                    help="""Model name.""")
...
transform_train = transforms.Compose([
    transforms.Pad(padding = 161),
    transforms.CenterCrop(500),  #先四周填充0，在吧图像随机裁剪成32*32
...
train_dataset = MyDataset(txt = args.train_path + 'glasses_train_label.txt', transform = transform_train)
...
test_dataset = MyDataset(txt = args.test_path + 'glasses_test_label.txt', transform = transform_test)
