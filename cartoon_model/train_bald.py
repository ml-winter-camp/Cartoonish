...
parser.add_argument('--num_classes', type=int, default=2,
                    help="""num classes""")
parser.add_argument('--model_path', type=str, default='./model_bald/',
                    help="""Save model path""")
parser.add_argument('--model_name', type=str, default='bald.pth',
                    help="""Model name.""")
...
train_dataset = MyDataset(txt = args.train_path + 'bald_train.txt', transform = transform_train)
print(len(train_dataset))
train_loader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True)
print(len(train_loader))
test_dataset = MyDataset(txt = args.test_path + 'bald_test.txt', transform = transform_test)
