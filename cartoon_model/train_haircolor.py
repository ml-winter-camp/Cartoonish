...
parser.add_argument('--num_classes', type=int, default=4,
                    help="""num classes""")
parser.add_argument('--model_path', type=str, default='./model_haircolor/',
                    help="""Save model path""")
parser.add_argument('--model_name', type=str, default='haircolor.pth',
                    help="""Model name.""")
...
train_dataset = MyDataset(txt = args.train_path + 'haircolor_train.txt', transform = transform_train)
print(len(train_dataset))
train_loader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True)
print(len(train_loader))
test_dataset = MyDataset(txt = args.test_path + 'haircolor_test.txt', transform = transform_test)
